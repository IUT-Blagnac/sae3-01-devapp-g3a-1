...
- BOUVET Bastien -- ScrumMaster / Développeur
- BRUN Yolan -- Chef de projet / Développeur
- XXX Leonardo -- Développeur
- XXX-XXX Diego -- Développeur
- KEBAB Daner -- Développeur
- CRISTINI Aidan -- GitMaster / Développeur

Tuteur/tutrice enseignant(e) de l'équipe:: Rémi BOULE
