...
- BOUVET Bastien -- Scrum Master / Développeur
- BRUN Yolan -- Chef de projet / Rédacteur / Développeur
- CORREIA MENDES Leonardo -- Développeur
- PENICAUD-BERNAL Diego -- Responsable base de donnée / Développeur
- SHARIFI Daner -- Responsable serveur web / Développeur
- CRISTINI Aidan -- Git Master / Développeur
