...
image::./images/pagedegarde.png[][alt="Dashboard du Département", align="center", width=100%]
...
|        | 1er Sprint | Release de fin de sprint | https://github.com/IUT-Blagnac/SAE-ALT-S3-Dev-24-25-Dashboard_du_departement-Equipe-3A01/releases/tag/1.0[Release de fin de sprint] | Release de fin de sprint
