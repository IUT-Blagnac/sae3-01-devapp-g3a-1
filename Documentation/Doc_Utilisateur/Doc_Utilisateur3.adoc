...
Une fois une salle sélectionnée, l'utilisateur accède à une page dédiée à la salle, affichant les données des capteurs et un graphique de l'historique des mesures. Les données des capteurs s'affichent en bas de la page, en dessous du graphique.

image::../../images/screen_site/b105_selected.png[align="center", width=100%]

En remontant en haut de la page, l'utilisateur peut revenir à la carte du 1er étage et cliqué sur une autre salle pour consulter ses données.

=== Manipulation des données

Il est possible d'interagit avec le graphique pour modifier l'affichage avec le menu en haut a droite du graphique.

image::../../images/screen_site/top_graph.png[align="center", width=50%]

Le menu déroulant permet de choisir les données par :
...
3. L'utilisateur utilise les options du graphique pour visualiser les données d'occupation sur les 7 derniers jours :
   - En sélectionnant le mode "Hebdomadaire" dans le menu déroulant.  
